# Contributing to osquery-extension
...
For `osquery-extension`, that usually means considering macOS, Windows, and Linux when designing a change. Not every feature will make sense on every operating system, and some data sources are inherently platform-specific. That is fine, but the issue or pull request should make the intended platform support clear.
